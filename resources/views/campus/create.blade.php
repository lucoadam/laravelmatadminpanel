...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('campus.store') }}" autocomplete="off" class="form-horizontal">
            @csrf
            @method('post')
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('no_of_students') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('no_of_students') ? ' is-invalid' : '' }}" name="no_of_students" id="input-no_of_students" type="text" placeholder="{{ __('No_of_students') }}" value="{{ old('no_of_students') }}" required="true" aria-required="true"/>
