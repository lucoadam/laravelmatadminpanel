...
{{--          <i><img style="width:25px" src="{{ asset('material') }}/img/laravel.svg"></i>--}}
      ...
      <li class="nav-item {{ ($activePage == 'profile' || $activePage == 'department-management') ? ' active' : '' }}">
        <a class="nav-link {{ ($activePage == 'profile' || $activePage == 'department-management') ? '' : 'collapsed' }}" data-toggle="collapse" href="#settingManagement" aria-expanded="{{ ($activePage == 'profile' || $activePage == 'user-management') ? 'true' : 'false' }}">
          {{--          <i><img style="width:25px" src="{{ asset('material') }}/img/laravel.svg"></i>--}}
