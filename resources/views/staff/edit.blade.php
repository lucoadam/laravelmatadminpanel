                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('country') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('country') ? ' is-invalid' : '' }}" name="country" id="input-country" type="text" placeholder="{{ __('Country') }}" value="{{ old('country', $staff->country) }}" required="true" aria-required="true"/>
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('city') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('city') ? ' is-invalid' : '' }}" name="city" id="input-city" type="text" placeholder="{{ __('City') }}" value="{{ old('city', $staff->city) }}" required="true" aria-required="true"/>
                      @if ($errors->has('city'))
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('salary') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('salary') ? ' is-invalid' : '' }}" name="salary" id="input-salary" type="text" placeholder="{{ __('Salary') }}" value="{{ old('salary', $staff->salary) }}" required="true" aria-required="true"/>
