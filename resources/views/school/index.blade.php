        ...
        <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-primary">
                <h4 class="card-title ">{{ __('School') }}</h4>
                <p class="card-category"> {{ __('Here you can manage school') }}</p>
              </div>
              <div class="card-body">
                @if (session('status'))
                  <div class="row">
                      ...
                      @foreach($school as $model)
						...
						<td>
                          ...
                          <td class="td-actions text-right">
                              <form action="{{ route('school.destroy', $model) }}" method="post">
                                  @csrf
                                  @method('delete')
                              
                                  <a rel="tooltip" class="btn btn-success btn-link" href="{{ route('school.edit', $model) }}" data-original-title="" title="">
