                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('permission') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('permission') ? ' is-invalid' : '' }}" name="permission" id="input-permission" type="text" placeholder="{{ __('Permission') }}" value="{{ old('permission', $permission->permission) }}" required="true" aria-required="true"/>
