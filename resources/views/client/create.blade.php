                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('database') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('database') ? ' is-invalid' : '' }}" name="database" id="input-database" type="text" placeholder="{{ __('Database') }}" value="{{ old('database') }}" required="true" aria-required="true"/>
